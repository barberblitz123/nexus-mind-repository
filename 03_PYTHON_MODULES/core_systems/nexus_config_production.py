...
class ProductionConfig(BaseSettings):
    ...
    # Webinar interface settings
    WEBINAR_PORT: int = Field(default=8003, env="WEBINAR_PORT")
    WEBINAR_MAX_PARTICIPANTS: int = Field(default=100, env="WEBINAR_MAX_PARTICIPANTS")
    WEBINAR_ENABLE_RECORDING: bool = Field(default=False, env="WEBINAR_ENABLE_RECORDING")
